            ...
            <form action="{{route('admin.postaddtb')}}" method="POST" class="row mb-3" >
                ...
                {{-- <div class="border border-dark"> --}}
                    <div class="col-md-11 pb-3">
                        ...
                        <input type="text" class="form-control" id="inputEmail4" name="td" placeholder="Tiêu đề thông báo..." value="{{old('td')}}">
                        @error('td')
                    ...
                    <div class="field">
                        <div class="control">
                          <textarea class="textarea"  name="nd" rows="7" cols="130" placeholder="Nội dung...." style="padding-top: 10px;" value="{{old('nd')}}"></textarea>
                        </div>
                        @error('nd')
                            <span style="color: red;">{{$message}}</span>
                        @enderror
                    ...
                    <div class="col-12" style="margin-top: 10px;">
                        <button type="submit" class="btn btn-success">Thêm thông báo <i class="fa-solid fa-check"></i></button>
