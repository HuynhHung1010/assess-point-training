...
@section('content')
    <main>
        ...
        <ul class="breadcrumbs">
            ...
            @endif
            <hr>
            <form action="{{route('admin.posteditnamhoc')}}" method="POST" class="row mb-3" >
                    <div class="col-mb-3">
                    <label for="inputEmail4" class="form-label">Tên năm học</label>
                    <input type="text" class="form-control" id="nh" name="nh" placeholder="Tên năm học..." value="{{old('nh') ?? $formDetail->tennam}}">
                    @error('nh')
                    ...
                    <div class="col-12" style="margin-top: 10px;">
                        ...
                        <a href="{{route('admin.listnam')}}" class="btn btn-danger">Trở về <i class="fa-solid fa-rotate-left"></i></a>
                    </div>
            </form>
    </main>
@endsection
