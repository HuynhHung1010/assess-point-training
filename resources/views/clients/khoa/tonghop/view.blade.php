...
<div class="p-3 border">
            ...
            <div class="pb-3 d-flex" style="padding-right: 10px;">
                ...
                <div class="col-5">
                    <select class="form-control" name="idkhoahoc">
                        <option value="0">----Khoá học----</option>
                        @if (!empty($getnk))
    ...
    <div class="pb-3 d-flex justify-content-end">
        {{-- <a href="{{route('khoa.khoaxuatfilePDF', ['keywords'=>$keywords,'nh'=>$nh,'hk'=>$hk,'lop'=>$lop,'gv'=>$gv,'khoahoc'=>$khoahoc])}}" class="pe-3 btn btn-success">Export PDF</a> --}}
        <a href="{{route('khoa.khoaxuatfileEX', ['nh'=>$nh,'hk'=>$hk,'lop'=>$lop,'gv'=>$gv,'khoahoc'=>$khoahoc])}}" class="btn btn-success">Export Excel</a>
    </div>
    <div class="d-flex justify-content-center">
        <table id="customers">
        <tr>
