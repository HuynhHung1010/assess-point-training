...
<div class="p-3 border">
    ...
    <div class="text-center">
        <h3>Đoàn khoa trả lời phản hồi cho sinh viên:</h3>
    </div>
    <div class="d-flex justify-content-center">
        <form action="{{route('doan.postguiph')}}" method="POST">
            @csrf
            ...
            <div class="field">
                ...
                <div class="col-12 p-3 text-end">
                    ...
                    <a href="{{route('doan.svph')}}" class="btn btn-danger">Trở về <i class="fa-solid fa-rotate-left"></i></a>
                </div>
        </form>
    </div>
</div>
