...
<div class="p-3 border">
    <main>
        <ul class="breadcrumbs">
            ...
            <li class="divider">/</li>
            <li><a href="#" class="active">Phản hồi cho pctsv</a></li>
        </ul>
    </main>
    ...
    <hr>
    <div class="text-center">
        <h3>Phản hồi về điểm rèn luyện với PCTSV:</h3>
    </div>
    <div class="d-flex justify-content-center">
        <form action="{{route('sv.phanhoipct')}}" method="POST" class="mb-3">
            @csrf
