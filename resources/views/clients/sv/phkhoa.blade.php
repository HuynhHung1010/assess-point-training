...
<div class="p-3 border">
    <main>
        <ul class="breadcrumbs">
            ...
            <li class="divider">/</li>
            <li><a href="#" class="active">Phản hồi cho khoa</a></li>
        </ul>
    </main>
    ...
    <hr>
    <div class="text-center">
        <h3>Phản hồi về điểm rèn luyện với khoa:</h3>
    </div>
    <div class="d-flex justify-content-center">
        <form action="{{route('sv.phanhoikhoa')}}" method="POST" class="mb-3">
            @csrf
