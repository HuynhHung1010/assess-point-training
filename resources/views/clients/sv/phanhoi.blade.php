...
<div class="p-3 border">
    <main>
        <ul class="breadcrumbs">
            ...
            <li class="divider">/</li>
            <li><a href="#" class="active">Phản hồi cho GVCV</a></li>
        </ul>
    </main>
    ...
    <hr>
    <div class="text-center">
        <h3>Phản hồi về điểm rèn luyện với GVCV:</h3>
    </div>

    <div class="d-flex justify-content-center">
    <form action="{{route('sv.phanhoigv')}}" method="POST" class="mb-3" enctype="multipart/form-data">
        @csrf
