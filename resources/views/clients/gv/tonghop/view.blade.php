...
<div class="p-3 border">
        ...
        <form action="" method="get" class="mb-3">
            <div class="row">
                {{-- <div class="col-11 pb-3">
                    ...
                    placeholder="MSSV hoặc tên sinh viên,mã lớp, tên lớp..." value="{{request()->keywords}}">
                </div> --}}
                <br>
    ...
    <div class="pb-3 d-flex justify-content-end">
        {{-- <a href="{{route('gv.gvxuatfilePDF', ['keywords'=>$keywords,'nh'=>$nh,'hk'=>$hk,'lop'=>$lop,'khoahoc'=>$khoahoc])}}" class="pe-3 btn btn-info">Export PDF</a> --}}
        <a href="{{route('gv.gvxuatfileEX', ['nh'=>$nh,'hk'=>$hk,'lop'=>$lop,'khoahoc'=>$khoahoc])}}" class="btn btn-success">Export Excel</a>
    </div>
    <div class="d-flex justify-content-center">
        <table id="customers">
        <tr>
