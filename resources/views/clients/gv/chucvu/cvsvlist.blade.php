...
<div class="p-3 border">
    ...
    <div class="d-flex justify-content-center">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td><a href="{{route('gv.cnchucvudssv', ['idsv'=>$item->idhs,'idlop'=>$idlop])}}" class="btn btn-outline-dark"> <i class="fa-solid fa-pen-to-square"></i></a></td>
                </tr>
                @endforeach
                @else
                    <tr>
    ...
    <div class="col-12 p-3 text-end">
        <a href="{{route('gv.chucvulop')}}" class="btn btn-danger">Trở về <i class="fa-solid fa-rotate-left"></i></a>
    </div>
</div>
@endsection
